...
glm::vec3 lightPos2(1.5f, 3.0f, 0.5f);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 1.0f, 0.4f, 0.4f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 0.4f, 0.8f, 0.4f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.specular"), 0.4f, 0.4f, 0.4f);

        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 0.5f, 0.4f, 0.4f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 1.4f, 1.0f, 0.4f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.specular"), 0.4f, 0.4f, 0.4f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 1.0f, 0.4f, 0.3f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.3f, 0.6f, 1.3f);
